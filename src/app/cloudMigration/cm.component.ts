...
@Component({ templateUrl: 'cm.component.html' })
export class CMComponent implements OnInit, OnDestroy {
    currentUser: User;
    ...
    dataCenters: Tile[] = [
        {text: 'OnPrem', cols: 1, rows: 1, color: 'lightblue'},
        {text: 'Cloud', cols: 1, rows: 1, color: 'lightgreen'}
      ];
